#This will read in the vignetting file. 
...
class read_vcy_file():
    ...
    def __init__(self, folder='L3_20260317T0240-20260317T0241/', filename='SMILE_SXI_L3_SCIM15-SCI-VCY_20260317T0240-20260317T0241_V01.fits'):
        ...
        with fits.open(self.fullname) as hdul: 
            ...
            #Now data. 
            self.data = {} 
            self.data['VIGMAP'] = self.hdul['PRIMARY'].data 
    ...
    def plot_vcy_extension(self, ext = 'VIGMAP', cmap='lundi', vmin=0, vmax=1, save=True):
        ...
        #Make the axis. 
        make_image_axes.make_image_axes(ax, self.data['VIGMAP'], self.xdeg_min, self.ydeg_min, self.n_pixels, self.m_pixels, cmap=cmap, vmin=vmin, vmax=vmax, cbar_title='Counts/pixel')
        ax.set_title('VIGMAP'+'\n\n')
